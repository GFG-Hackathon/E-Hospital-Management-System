...
public class Patients extends Person// patient class Inheriting from person class//
{
	...
	public void PatientRegistration(
			int pid) /*
						 * This method add details of the patient in the patient table of EHMS database
						 */
	{
	...
	public void ViewReport(int id) {
		...
		if (checkReport == 0)
			System.out
					.println("*************************You Have No Report Generated**********************************");
	...
	public void Givefeedback(int id) /* To give Feedback */
	{
		...
		try {
			Connection con = ConnectionProvider.getCon();
			Statement st = con.createStatement();
			st.executeUpdate("INSERT INTO feedback VALUES ('" + pid + "','" + points + "','" + Doc_Nature + "','"
					+ Location + "','" + YourComment + "')");
